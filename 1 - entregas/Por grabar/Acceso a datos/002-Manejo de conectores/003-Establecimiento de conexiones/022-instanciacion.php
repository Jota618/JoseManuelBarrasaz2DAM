...
class conexionDB
{
	...
	public $conexion; // Almacena la conexión a la base de datos
...
// Muestra la contraseña almacenada en la propiedad 'contrasena'
echo $conexion->contrasena; // Muestra la contraseña (esto no es recomendable en un entorno de producción)
?>
